...
pub const Header = enum {
    ...
    pub fn width(self: Header) u16 {
        return switch (self) {
            .Rebel => comptime strWidth(rebel),
            .Shadow => comptime strWidth(shadow),
            .Bloody => comptime strWidth(bloody),
            .Fire => comptime strWidth(fire),
            .Paga => comptime strWidth(paga),
            .Calvin => comptime strWidth(calvin),
            .Templar => comptime strWidth(templar),
        };
    }
    ...
    pub fn height(self: Header) u16 {
        return switch (self) {
            .Rebel => comptime strHeight(rebel),
            .Shadow => comptime strHeight(shadow),
            .Bloody => comptime strHeight(bloody),
            .Fire => comptime strHeight(fire),
            .Paga => comptime strHeight(paga),
            .Calvin => comptime strHeight(calvin),
            .Templar => comptime strHeight(templar),
        };
    }
